...
export const ENTITY_VOICE_PROMPT_SETS: Record<EntityType, EntityVoicePromptSet> = {
  ...
  shape: {
    ...
    questions: [
      'Используй этот блок как свободное описание, контекст или пояснение. Сюда можно добавлять любые мысли, детали, наблюдения, цели, задачи и всё, что помогает лучше понять ситуацию.',
    ],
  },
};
